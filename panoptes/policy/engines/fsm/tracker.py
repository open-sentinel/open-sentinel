...
from panoptes.policy.engines.fsm.workflow.constraints import ConstraintEvaluator, ConstraintViolation
...
class WorkflowTracker:
    ...
    Example:
        ```python
        from panoptes.policy.engines.fsm import WorkflowTracker, WorkflowParser
