...
class NemoGuardrailsPolicyEngine(PolicyEngine):
    ...
    async def initialize(self, config: Dict[str, Any]) -> None:
        ...
        # Register Panoptes bridge actions
        self._register_panoptes_actions()
    ...
    def _register_panoptes_actions(self):
        """Register Panoptes-specific actions with NeMo."""
        if not self._rails:
            return

        async def panoptes_log_violation(
            violation_name: str,
            severity: str = "error",
            message: str = "",
        ) -> Dict[str, Any]:
        ...
        async def panoptes_request_intervention(
            intervention_name: str,
            context: Optional[Dict[str, Any]] = None,
        ) -> Dict[str, Any]:
            """
            Request a Panoptes intervention from NeMo context.

            Allows Colang flows to trigger Panoptes interventions.
            """
        ...
        self._rails.register_action(panoptes_log_violation, "panoptes_log_violation")
